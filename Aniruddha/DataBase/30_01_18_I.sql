/* 
   A Database is the collection of data i.e the main container, it contains the data and log files, and all the schemas within it.
   ...
   Its model is developed by Dr. E.F. CODD and according to him any package can be called as RDBMS only if it satisfies the Codd Rules.
